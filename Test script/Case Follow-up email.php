<?php
    ...
    $filter_limit_select = array(
      ...
      '_ff[]'                => 'case_status[value]', 'cf_case_followup_email', // Filter by this column
      '_ft[]'                => 'bg', 'bg',                               
      '_fc[]'                => 'Awaiting customer response', '',                      
    ...
    //updating cases to say follow-up email has been sent 


    // relating emails and cases 
    //$create_relArray = array(
    'source_id'        => $case_id,
    'source_type'      => 'Private::Crm::Case',
    'related_item_id'   => $,
...
//loop cases found as currently it will run for a case 
